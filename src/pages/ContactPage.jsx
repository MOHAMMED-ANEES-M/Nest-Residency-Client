...
const ContactPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 mt-10">
      <h1 className="text-3xl sm:text-4xl mb-5 sm:mb-10 text-center text-[#912501]">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl text-[#912501]">Our Location</h2>
          <p className="text-lg">
      ...
      <div className="text-center">
        <h2 className="text-[30px] mb-5 text-center text-[#912501]">Visit Us</h2>
        <iframe 
