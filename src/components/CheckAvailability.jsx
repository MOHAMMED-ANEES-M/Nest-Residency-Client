...
const CheckAvailability = () => {
  ...
  return (
    <div className="mt-32 mb-20">
      <h1 className="text-xl mx-20 p-3 text-white font-semibold bg-green-800 mb-10">
        Check Availability
      </h1>
      ...
      {availableRooms?.length > 0 && (
        <div>
          <h3 className="text-xl mx-20 p-3 text-white font-semibold bg-green-800 mb-10 mt-20">
            Available Rooms
          </h3>
          <div className="grid grid-cols-1 gap-10 justify-center mx-20">
            {availableRooms?.map((roomId) => {
              ...
              return <RoomCard key={room.roomId} room={room} vrbtn="hidden" />;
            })}
          </div>
        </div>
      )}
